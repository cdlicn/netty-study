...
public class MultiThreadServer {
    public static void main(String[] args) throws IOException {
        ...
        Worker[] workers = new Worker[Runtime.getRuntime().availableProcessors()]; // Runtime.getRuntime().availableProcessors() CPU可用的核心数
        ...
        while (true) {
            ...
            while (iter.hasNext()) {
                ...
                if (key.isAcceptable()) {
                    ...
                    // round robin 轮询
                    workers[index.getAndIncrement() % workers.length].register(sc); // boss调用，初始化 selector ， 启动 worker
