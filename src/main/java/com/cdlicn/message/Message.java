...
public abstract class Message implements Serializable {
    ...
    public static final Map<Integer, Class<?>> MESSAGE_CLASSES = new HashMap<>();
    ...
    static {
        ...
        MESSAGE_CLASSES.put(GROUP_MEMBER_REQUEST_MESSAGE, GroupMembersRequestMessage.class);
        MESSAGE_CLASSES.put(GROUP_MEMBER_RESPONSE_MESSAGE, GroupMembersResponseMessage.class);
